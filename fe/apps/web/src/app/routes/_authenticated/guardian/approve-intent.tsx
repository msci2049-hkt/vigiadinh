      ...
      {item ? (
        <Card className="bg-paper-2">
          <CardContent className="flex flex-col gap-4 pt-6">
            ...
            {/* Lô R2/R3 §5.4 — tín hiệu rủi ro hiện LUÔN ở màn guardian: người
                đang quyết là tiền của NGƯỜI KHÁC. Có AI thì câu chữ, không thì
                số thô — nằm trên nút duyệt, cạnh khối hướng dẫn gọi điện. */}
            <AiAdvisorCard intentId={item.intent_id} audience="guardian" />
