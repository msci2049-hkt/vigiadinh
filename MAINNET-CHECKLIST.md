...
```
**THÊM (optional — để ttl-keeper phủ đủ hạ tầng, giá trị CÔNG KHAI; bản PROD-pin 2026-07-27):**
```
CONTRACT_ID_ORIGIN_VERIFIER=CAYJGXLB5J23S6DYFWS5VTFRVCEN5NLIUJCTO6GTM6LDQOYB7J6EOYQS
ACCOUNT_WASM_HASH=2c19ee49d7f25a6a052e2dc16489e5b1b10afc322ff6a8a8483d0e408c796f35
```
**XOÁ:**
```
